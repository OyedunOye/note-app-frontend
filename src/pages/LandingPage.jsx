      ...
      <div className="min-h-screen w-full bg-gradient">
        <div className='bg-gradient md:sticky top-0 left-0 h-1/2 z-10 border-b-2 border-b-green-900'>
          ...
          <div className='flex flex-col w-2/3 mx-auto py-1 gap-6 items-center'>
            ...
            <form className='flex flex-col w-full mx-auto py-1 gap-4 items-center'>
              <input type='text' placeholder='Enter the title of your note...' className='h-10 w-full px-2 rounded-md shadow-md bg-white' />
              <textarea placeholder='Enter your note content...' className='h-28 w-full px-2 rounded-md shadow-md bg-white'></textarea>
